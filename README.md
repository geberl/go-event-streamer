...
*Minimal reproducer to debug gRPC and http2 streaming APIs*
...
curl -H2 -k https://example.com:5001/stream

# insecure h2c
curl --http2-prior-knowledge http://example.com:5001/
curl --http2-prior-knowledge http://example.com:5001/stream
```
